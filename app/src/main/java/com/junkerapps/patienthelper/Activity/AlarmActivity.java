package com.junkerapps.patienthelper.Activity;
...
public class AlarmActivity extends AppCompatActivity {
    ...
    private MediaPlayer mRingtoneAlarm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mRingtoneAlarm == null || !mRingtoneAlarm.isPlaying()) {
            ...
            if (mRingtoneAlarm == null) {
                mRingtoneAlarm = MediaPlayer.create(getApplicationContext(), R.raw.alarm_tone);
            }
            mRingtoneAlarm.setLooping(true);
            mRingtoneAlarm.start();
        }
        ...
        mButton = findViewById(R.id.buttonStop);
        mTextViewDescription = findViewById(R.id.textViewDescription);
        mTextViewHour = findViewById(R.id.textViewHour);


        Bundle bundle = this.getIntent().getExtras().getBundle("alarm");
        if (bundle != null) {
            mTextViewDescription.setText(bundle.getString("Description"));
            mTextViewHour.setText(bundle.getString("Hour"));
        }
